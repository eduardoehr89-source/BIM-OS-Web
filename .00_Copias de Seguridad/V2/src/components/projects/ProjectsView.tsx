...
import { Building2, ClipboardList, FilterX, Paperclip, ScrollText, Trash2, Plus, X } from "lucide-react";
...
type WorkspaceTab = "proyecto" | "tareas" | "docs" | "adjuntos";
            ...
            <div className="space-y-6">
              ...
              {workspaceTab === "adjuntos" && (
                <div className="space-y-4">
                  <p className="text-sm text-muted-foreground">Archivos generales (PDF y DWG). No usan clasificación BEP/OIR/EIR.</p>
                  <label className="inline-flex cursor-pointer items-center gap-2 rounded-lg bg-muted/60 px-4 py-3 text-xs font-medium dark:bg-muted/25">
                    ...
                    <input type="file" accept=".pdf,.dwg" multiple className="hidden" disabled={uploadBusy} onChange={onUploadGeneral} />
