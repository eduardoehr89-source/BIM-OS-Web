import type { ProjectStatus as PrismaProjectStatus } from "@/generated/prisma";

/** Igual que `enum ProjectStatus` en Prisma; la UI muestra texto legible vía `labelProjectStatus`. */
export type ProjectStatusCode = PrismaProjectStatus;
...
export const DEFAULT_PROJECT_STATUS: ProjectStatusCode = "INICIO_PENDIENTE";
