        ...
        <section className="rounded-2xl bg-muted/10 p-6 border border-border/40 max-w-2xl">
          ...
          <form onSubmit={createClient} className="space-y-4">
            ...
            <div className="grid gap-4 sm:grid-cols-3">
              <label className="block text-xs font-medium text-muted-foreground">
                OIR (PDF/Word) *
                <input name="oir" type="file" accept=".pdf,.doc,.docx" required className="mt-1 block w-full text-xs text-foreground file:mr-2 file:rounded file:border-0 file:bg-muted file:px-2 file:py-1" />
              </label>
              <label className="block text-xs font-medium text-muted-foreground">
                AIR (PDF/Word) *
                <input name="air" type="file" accept=".pdf,.doc,.docx" required className="mt-1 block w-full text-xs text-foreground file:mr-2 file:rounded file:border-0 file:bg-muted file:px-2 file:py-1" />
              </label>
              <label className="block text-xs font-medium text-muted-foreground">
                EIR (PDF/Word) *
                <input name="eir" type="file" accept=".pdf,.doc,.docx" required className="mt-1 block w-full text-xs text-foreground file:mr-2 file:rounded file:border-0 file:bg-muted file:px-2 file:py-1" />
              </label>
            </div>
