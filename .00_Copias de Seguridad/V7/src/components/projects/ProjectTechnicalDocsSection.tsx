  ...
  return (
    <div className="space-y-6">
      <p className="text-sm text-muted-foreground">
        Documentación técnica en PDF (BEP, OIR, EIR u otros). BEP también admite Word (.doc, .docx). El resto de clasificaciones solo PDF.
      </p>
                ...
                return (
                  <tr key={f.id} className="hover:bg-background/50 dark:hover:bg-background/10">
                    ...
                    <td className="px-4 py-3 text-right">
                      ...
                      <button type="button" className="text-destructive hover:underline" title="Eliminar" onClick={() => setTrashDocId(f.id)}>
